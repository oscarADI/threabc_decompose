...
void Th_PrintNode ( Thre_S * tObj )
{
  int i;
  printf(".threshold ");

  int fanin;
  Vec_IntForEachEntry( tObj->Fanins, fanin, i ) 
  {
    printf("%d ", fanin);
  }
  printf("%d\n", tObj->Id);
  ...
  int weight;
  Vec_IntForEachEntry( tObj->weights, weight, i ) 
  {
    printf("%d ", weight);
  }
  printf("%d\n", tObj->thre);
  ...
  int dtype;
  Vec_IntForEachEntry( tObj->dtypes, dtype, i ) 
  {
    printf("%d ", dtype);
  }
  printf("\n");

  /*if (Vec_IntSize(tObj->thres) != 0)*/
  /*{*/
  int t;
  Vec_IntForEachEntry( tObj->thres, t, i ) 
  {
    printf("%d ", t);
  }
  printf("\n");
